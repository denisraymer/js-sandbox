...
- Что бы сравнить массиво необходимо сравнить ссылки по которой он находится 
...
### Длина массива
- Свойство length обновляется автоматически при добавлении нового эдемента в массив
```JS
...
- Типы циклов
  ...
  - **while**
    ...
    ```
  - **do ... while**
    - Используется когда нужно выполнить БК хотябы один раз
    ```js
      let j = 0 // Условие
      do {
        // Блок кода, выполняемый на каждой итерации
