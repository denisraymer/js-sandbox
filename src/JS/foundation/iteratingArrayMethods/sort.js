const description = 'На месте сортирует элементы массива и возвращает отсортированный массив';
...
const methodSort = function (data, type) {
    switch (type) {
        case 'searchByName':
            return data.find(user => user.name === 'Lucile Finley');
        default:
            return data
    }
}
...
console.log(methodSort(users, 'searchByName'));

// sortByAge - Вернет объект отсортированный по возрасту
